...
class DialogFlowConnector extends EventEmitter {
    constructor(audioConfig, dialogFlowConfig, id, log) {
        ...
        this._dialogFlowClient = new dialogflow.SessionsClient({credentials: dialogFlowConfig.auth});
        this._dialogFlowPath = this._dialogFlowClient.projectAgentSessionPath(this._dialogFlowProjectId, this._dialogFlowSessionId);
